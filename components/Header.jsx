...
export default function Header() {
  ...
  return (
    <>
      <header>
        <div className="header-inner">
          ...
          <div className="nav-cta">
            <a className="btn-wa-nav" href="https://wa.me/528117783953" target="_blank" rel="noopener noreferrer">
      ...
      <a className="wa-float" href="https://wa.me/528117783953" target="_blank" rel="noopener noreferrer" title="Escríbenos por WhatsApp">
